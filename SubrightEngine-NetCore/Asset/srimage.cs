...
namespace SubrightEngine.Asset
{
    public class srimage
    {
        ...
        //Create an image file from an existing file!
        public void CreateImageFile(string existingFilePath, string newPath)
        {
            string format = "|";
            if (File.Exists(existingFilePath))
            {
                //System.Drawing.Bitmap bitmap = System.Drawing.Image.FromFile(existingFilePath);
                /*if (bitmap != null)
                {
            ...
            {
                Debug.Error("existing file doesnt exist! for use to convert over from png to srimage.");
            }
        }
    }
}
